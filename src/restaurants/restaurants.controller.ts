...
export class RestaurantsController {
  ...
  @UseGuards(new RolesGuard([process.env.SUPERADMIN_RIGHTS, process.env.ADMIN_RIGHTS]) || new SocietyScopeGuard([process.env.USER_RIGHTS]))
  @Post()
  create(@Body() createRestaurantDto: CreateRestaurantDto) {
    return this.restaurantsService.create(createRestaurantDto);
  }

  @UseGuards(new RolesGuard([process.env.SUPERADMIN_RIGHTS, process.env.ADMIN_RIGHTS]) || new SocietyScopeGuard([process.env.RESTAURANT_RIGHTS]))
  @Post(':id/menus')
